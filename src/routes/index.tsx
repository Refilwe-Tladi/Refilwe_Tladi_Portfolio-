  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <main>
        <section id="home" className="relative min-h-[calc(100vh-4.5rem)] border-b border-border">
          <div className="mx-auto grid min-h-[calc(100vh-4.5rem)] max-w-7xl items-center gap-12 px-5 py-14 lg:grid-cols-[1.2fr_0.8fr] lg:px-8 lg:py-20">
            <div className="max-w-3xl">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row"><Button asChild variant="portfolio" size="lg"><a href="#projects">Explore My Portfolio <ArrowDown /></a></Button><CvButton /></div>
            </div>
        ...
        <section id="education" className="section-rose border-y border-border"><div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28"><SectionHeading eyebrow="Learning journey" title="Education" /><div className="relative ml-3 max-w-4xl border-l border-primary/30 pl-8 sm:pl-12"><div className="relative pb-12"><span className="absolute -left-[2.6rem] top-1 grid size-6 place-items-center rounded-full bg-primary text-primary-foreground sm:-left-[3.8rem]"><Check className="size-3.5" /></span><p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">Completed</p><h3 className="mt-2 font-display text-2xl font-bold">Full-Stack Development Certificate</h3><p className="mt-2 text-muted-foreground">FNB App Academy</p><p className="mt-4 text-sm italic text-muted-foreground">Dates can be added here.</p></div><div className="relative pb-12"><span className="absolute -left-[2.6rem] top-1 size-6 rounded-full border-[6px] border-primary bg-background sm:-left-[3.8rem]" /><p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">In development</p><h3 className="mt-2 font-display text-2xl font-bold">AI Development Skills Programme</h3><p className="mt-2 leading-7 text-muted-foreground">Currently developing my skills through an AI Development Skills programme accredited with Google and SETA.</p><p className="mt-4 text-sm italic text-muted-foreground">Institution and dates can be added here.</p></div><div className="relative rounded-lg border border-dashed border-primary/30 bg-background/50 p-5"><GraduationCap className="mb-3 text-primary" /><h3 className="font-bold">Add another qualification or course</h3><p className="mt-2 text-sm text-muted-foreground">Editable space for an institution, qualification, dates or additional course.</p></div></div></div></section>

        <section id="certifications" className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28"><SectionHeading eyebrow="Credentials" title="Certifications" /><div className="grid gap-6 md:grid-cols-2"><article className="rounded-lg border border-border bg-card p-7 shadow-sm"><div className="mb-7 h-1 w-16 rounded-full bg-primary" /><GraduationCap className="size-9 text-primary" /><h3 className="mt-5 font-display text-2xl font-bold">Full-Stack Development Certificate</h3><p className="mt-2 text-muted-foreground">FNB App Academy</p><p className="mt-6 border-t border-border pt-5 text-sm text-muted-foreground">Certificate image or verification link can be added here.</p></article><article className="rounded-lg border border-border bg-card p-7 shadow-sm"><div className="mb-7 h-1 w-16 rounded-full bg-primary" /><BrainCircuit className="size-9 text-primary" /><h3 className="mt-5 font-display text-2xl font-bold">AI Development Skills Programme</h3><p className="mt-2 text-muted-foreground">Google and SETA accredited</p><p className="mt-6 border-t border-border pt-5 text-sm text-muted-foreground">Certificate image or verification link can be added here.</p></article></div></section>

        <section id="experience" className="section-rose border-y border-border"><div className="mx-auto max-w-7xl px-5 py-20 lg:px-8 lg:py-28"><div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]"><SectionHeading eyebrow="Professional journey" title="Work Experience" /><div className="rounded-lg border border-dashed border-primary/30 bg-card p-7 sm:p-9"><BriefcaseBusiness className="size-10 text-primary" /><h3 className="mt-6 font-display text-2xl font-bold">Your experience belongs here</h3><p className="mt-3 leading-7 text-muted-foreground">Explore my CV for a detailed overview of my professional experience.</p><div className="mt-6 grid gap-2 text-sm text-muted-foreground sm:grid-cols-2"><span>Job title</span><span>Company</span><span>Employment dates</span><span>Responsibilities &amp; achievements</span></div><div className="mt-8"><CvButton /></div></div></div></div></section>
